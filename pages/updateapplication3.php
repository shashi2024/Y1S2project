...
if (isset($_FILES['Birth_Certificate']) && $_FILES['Birth_Certificate']['error'] === UPLOAD_ERR_OK) {
    ...
    $targetDirectory = 'UP_BirthCertificate/';
...
if (mysqli_query($conn, $sql)) {
    ...
    echo '<script>
        setTimeout(function() {
            window.location.href = "updateDrivingLicense.html";
